...
{
    public class VorzeUFOSA : ITargetDevice
    {
        ...
        public async void InitPosition()
        {
            ...
            // Stop.
            await this.characteristic.WriteValueAsync(new byte[] { 2, 1, 0 }.AsBuffer());
        }
        ...
        public async void PublishCommand(DeviceCommand command)
        {
            ...
            await this.characteristic.WriteValueAsync(new byte[] { 2, 1, (byte)(speed + directionFlag)}.AsBuffer());
        }
